        ...
        pmatch rdm $ \case
            PGenesis info -> P.do
                ...
                let newRawDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # newOutputF.datum )
                    ...
                    osRawDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # osOutputF.datum )
            ...
            POnto info -> P.do
                ...
                let rawHeadDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # headInputF.datum )
                    rawContinuingDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # continuingOutputF.datum )
                    rawNewDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # newOutputF.datum )
            ...
            PBetween info -> P.do
                ...
                continuingOutputF <- pletFields @'["address", "value", "datum"] continuingOutput
                newOutputF <- pletFields @'["address", "value", "datum"] newOutput
                let rawParentDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # parentInputF.datum )
                    rawContinuingDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # continuingOutputF.datum )
                    rawNewDatum = pfromPDatum @PTrieDatum # (ptryFromInlineDatum # newOutputF.datum )
